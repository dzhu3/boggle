...
The program will fail to run if the implementations for `MyGameDictionary`
...
import argparse
import math
from py_boggle import my_dictionary, my_game_manager
...
def run_boggle(args):
    mydict = my_dictionary.MyGameDictionary()
    ...
    while choice != 'q':
        ...
        if choice == "q":
            ...
            all_words = mygame.get_all_words()
            comp_words = []
            comp_score = 0
